...
# Embedding policy: raw interactions are NEVER embedded — vectors live on
# the distilled tiers only (memories / intelligence / knowledge). The raw
# tier is recalled via get-context and fulltext search; telemetry rows feed
# knowledge generation, not vector search.
